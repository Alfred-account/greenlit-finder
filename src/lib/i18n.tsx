...
Object.assign(ru, {
  ...
  "auth.checkEmail": "Мы отправили шестизначный код на",
...
Object.assign(kk, {
  ...
  "auth.checkEmail": "Алты таңбалы кодты мына поштаға жібердік:",
...
Object.assign(en, {
  ...
  "auth.checkEmail": "We sent a six-digit code to",
...
Object.assign(ru, {
  ...
  "auth.codeTitle": "Подтвердите почту",
  "auth.codeLabel": "Шестизначный код подтверждения",
  "auth.verifyCode": "Подтвердить аккаунт",
  "auth.resendCode": "Отправить код повторно",
  "auth.badCode": "Неверный или просроченный код",
  "auth.codeResent": "Новый код отправлен",
  "auth.codeVerified": "Почта подтверждена",
...
Object.assign(kk, {
  ...
  "auth.codeTitle": "Поштаны растаңыз",
  "auth.codeLabel": "Алты таңбалы растау коды",
  "auth.verifyCode": "Аккаунтты растау",
  "auth.resendCode": "Кодты қайта жіберу",
  "auth.badCode": "Код қате немесе мерзімі өткен",
  "auth.codeResent": "Жаңа код жіберілді",
  "auth.codeVerified": "Пошта расталды",
...
Object.assign(en, {
  ...
  "auth.codeTitle": "Confirm your email",
  "auth.codeLabel": "Six-digit confirmation code",
  "auth.verifyCode": "Confirm account",
  "auth.resendCode": "Resend code",
  "auth.badCode": "The code is invalid or expired",
  "auth.codeResent": "A new code was sent",
  "auth.codeVerified": "Email confirmed",
