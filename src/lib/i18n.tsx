...
Object.assign(ru, {
  ...
  "filter.age": "Возраст",
  "age.suffix": "лет",
  "card.top": "Продвижение",
  "banner.demo": "Показаны демо-данные — Airtable недоступен.",
  "share.titlePlaceholder": "Название возможности",
...
Object.assign(kk, {
  ...
  "age.suffix": "жас",
  "card.top": "Ұсынылған",
  "banner.demo": "Демо-деректер көрсетілген — Airtable қолжетімсіз.",
  "share.titlePlaceholder": "Мүмкіндік атауы",
...
Object.assign(en, {
  ...
  "age.suffix": "y.o.",
  "card.top": "Featured",
  "banner.demo": "Showing demo data — Airtable is unavailable.",
  "share.titlePlaceholder": "Opportunity name",
...
const SPHERE_HINTS: Record<Lang, Dict> = {
  "ru": {
    "Computer Science & Technology": "программирование, хакатоны, робототехника",
    "Law": "мут-корты, судебные игры, правовые олимпиады",
    "International Relations": "МУН, дебаты, международные конференции",
    "Medicine & Biology": "олимпиады по биологии, медицинские школы",
    "Journalism & Media": "школьные СМИ, эссе, блогинг, подкасты",
    "Film & Directing": "короткометражки, кинофестивали, видеомонтаж",
    "Art & Design": "рисунок, дизайн, фото, выставки",
    "Business & Economics": "стартапы, бизнес-кейсы, экономика",
    "Science & Research": "научные проекты, физика, химия, математика",
    "Engineering": "робототехника, инженерные турниры, изобретения",
    "Psychology & Social Sciences": "психология, соцпроекты, волонтёрство",
    "Humanities & Languages": "языки, история, литература",
    "Environment & Sustainability": "экология, климат, эко-проекты",
    "Politics & Public Policy": "молодёжный парламент, дебаты, лидерство"
  },
  "kk": {
    "Computer Science & Technology": "бағдарламалау, хакатондар, робототехника",
    "Law": "мут-корттар, сот ойындары, құқық олимпиадалары",
    "International Relations": "MUN, дебаттар, халықаралық конференциялар",
    "Medicine & Biology": "биология олимпиадалары, медицина мектептері",
    "Journalism & Media": "мектеп БАҚ-ы, эссе, блогинг, подкасттар",
    "Film & Directing": "қысқаметражды фильмдер, кинофестивальдер, монтаж",
    "Art & Design": "сурет, дизайн, фото, көрмелер",
    "Business & Economics": "стартаптар, бизнес-кейстер, экономика",
    "Science & Research": "ғылыми жобалар, физика, химия, математика",
    "Engineering": "робототехника, инженерлік турнирлер, өнертабыс",
    "Psychology & Social Sciences": "психология, әлеуметтік жобалар, волонтерлік",
    "Humanities & Languages": "тілдер, тарих, әдебиет",
    "Environment & Sustainability": "экология, климат, эко-жобалар",
    "Politics & Public Policy": "жастар парламенті, дебаттар, көшбасшылық"
  },
  "en": {
    "Computer Science & Technology": "coding, hackathons, robotics",
    "Law": "moot courts, mock trials, law olympiads",
    "International Relations": "MUN, debates, international conferences",
    "Medicine & Biology": "biology olympiads, medical schools",
    "Journalism & Media": "school media, essays, blogging, podcasts",
    "Film & Directing": "short films, film festivals, video editing",
    "Art & Design": "drawing, design, photo, exhibitions",
    "Business & Economics": "startups, business cases, economics",
    "Science & Research": "research projects, physics, chemistry, math",
    "Engineering": "robotics, engineering contests, inventions",
    "Psychology & Social Sciences": "psychology, social projects, volunteering",
    "Humanities & Languages": "languages, history, literature",
    "Environment & Sustainability": "ecology, climate, eco-projects",
    "Politics & Public Policy": "youth parliament, debates, leadership"
  }
};
